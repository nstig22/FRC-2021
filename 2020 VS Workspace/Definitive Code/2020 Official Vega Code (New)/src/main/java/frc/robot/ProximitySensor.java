...
class ProximitySensor extends Robot {
    ...
    private static double measuredVoltage;

    // Creating the sensor.
    private static AnalogInput proxSensor;
    ...
    public double getDistance() {
        double distance = (measuredVoltage * SENSOR_RES) / MM_PER_INCH;
